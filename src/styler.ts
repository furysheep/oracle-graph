...
type StyleVariants = { [key in StyleVariantsKeys]: Style }
...
type ShapeStyle = { [key in ShapeType]: StyleVariants }
export class Styler {
  /**
  ...
  colorLookup(columnCount: number) {
    ...
    let colorLookupSize =
      columnCount > maxSchemeSize ? maxSchemeSize : columnCount
